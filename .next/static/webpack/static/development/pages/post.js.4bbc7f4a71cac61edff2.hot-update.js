...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Post, [{
    ...
    value: function componentDidMount() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_6___default.a.get("https://freckbeauty.com/wp-json/wp/v2/".concat(apiRoute, "?slug=").concat(slug, "&_embed?slug=").concat(slug)).then(function (post) {
        _this2.setState({
          post: post.data[0]
        });
      });
...
//# sourceMappingURL=post.js.4bbc7f4a71cac61edff2.hot-update.js.map