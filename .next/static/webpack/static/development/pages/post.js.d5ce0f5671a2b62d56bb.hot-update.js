  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Post, [{
    ...
    value: function () {
      ...
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(ctx) {
        var _ctx$query, slug, apiRoute, post;

        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _ctx$query = ctx.query, slug = _ctx$query.slug, apiRoute = _ctx$query.apiRoute;
                _context.next = 3;
                return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_8___default()("https://freckbeauty.com/wp-json/wp/v2/".concat(apiRoute, "?slug=").concat(slug, "&_embed")).then(function (res) {
                  return res.json();
                });
...
//# sourceMappingURL=post.js.d5ce0f5671a2b62d56bb.hot-update.js.map