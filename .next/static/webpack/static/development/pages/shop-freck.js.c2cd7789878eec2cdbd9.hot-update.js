        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_12___default()("".concat(server, "/wp-json/wc/v3/orders?consumer_key=").concat(process.env.KEY, "&consumer_secret=").concat(process.env.SECRET), {
                  mode: 'cors',
...
//# sourceMappingURL=shop-freck.js.c2cd7789878eec2cdbd9.hot-update.js.map